...
echo [3/8] Descriptive statistics...
...
echo [5/8] RQ1 - VAS change analysis...
...
echo [6/8] RQ2 - Success rate vs benchmark...
...
echo [7/8] RQ3 - Logistic regression...
...
echo [8/8] RQ4 - Machine learning model...
